...
final class HttpClientInstrumentation
{
    ...
    const NO_TRACES_CLIENTS = [
        ...
        TraceableHttpClient::class,
        UriTemplateHttpClient::class,
    ];
    ...
    {
        $instrumentation = new CachedInstrumentation('dayploy.opentelemetry_symfony.http');
        ...
        hook(
            ...
            pre: static function (
                ...
                $builder = $instrumentation
                    ->tracer()
                    ->spanBuilder(\sprintf('Internal %s', $params[0]))
